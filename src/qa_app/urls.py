...
urlpatterns = (
    ...
    url(r'^(?P<project_id>\d+)/upload_files$', view=views.upload_files_view, name="upload_files"),
    url(r'^(?P<project_id>\d+)/upload_files/(?P<usecase_id>\d+)$', view=views.upload_files_view, name="upload_files")
)
